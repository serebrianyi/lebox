...
var len__5725__auto___18042 = arguments.length;
var i__5726__auto___18043 = (0);
while(true){
if((i__5726__auto___18043 < len__5725__auto___18042)){
args__5732__auto__.push((arguments[i__5726__auto___18043]));

var G__18044 = (i__5726__auto___18043 + (1));
i__5726__auto___18043 = G__18044;
continue;
} else {
}
break;
...
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5733__auto__);
});
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq18040){
var G__18041 = cljs.core.first(seq18040);
var seq18040__$1 = cljs.core.next(seq18040);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__18041,seq18040__$1);
});
...
var G__18045 = (function (){
sb.append(ch);

return sb;
})()
;
var G__18046 = cljs.reader.read_char(rdr);
sb = G__18045;
ch = G__18046;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__18049 = (groups[(6)]);
var G__18050 = (10);
return parseInt(G__18049,G__18050);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__18051 = cljs.reader.read_char(rdr);
ch = G__18051;
continue;
} else {
return ch;
...
var G__18052 = (((mret === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,mret));
a = G__18052;
continue;
} else {
cljs.reader.unread(rdr,ch);
...
var G__18053 = (((o === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,o));
a = G__18053;
continue;
}
}
...
var G__18054 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__18055 = cljs.reader.read_char(reader);
buffer = G__18054;
ch = G__18055;
continue;
}
...
if(("\\" === ch)){
var G__18056 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__18057 = cljs.reader.read_char(reader);
buffer = G__18056;
ch = G__18057;
continue;
} else {
...
var G__18058 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__18059 = cljs.reader.read_char(reader);
buffer = G__18058;
ch = G__18059;
continue;
...
var G__18064 = (function (){var G__18062 = buffer;
G__18062.append(nch);

return G__18062;
})();
var G__18065 = cljs.reader.read_char(reader);
buffer = G__18064;
ch = G__18065;
continue;
}
...
var G__18066 = (function (){var G__18063 = buffer;
G__18063.append(ch);

return G__18063;
})();
var G__18067 = cljs.reader.read_char(reader);
buffer = G__18066;
ch = G__18067;
continue;
...
var G__18074 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
...
if((res === reader)){
var G__18078 = reader;
var G__18079 = eof_is_error;
var G__18080 = sentinel;
var G__18081 = is_recursive;
reader = G__18078;
eof_is_error = G__18079;
sentinel = G__18080;
is_recursive = G__18081;
continue;
} else {
return res;
}
...
var vec__18086 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18086,(10),null);
var v = vec__18086;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__18087 = months__$1;
var G__18088 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__18087,G__18088) : cljs.reader.days_in_month.call(null,G__18087,G__18088));
...
if(cljs.core.truth_(temp__4423__auto__)){
var vec__18090 = temp__4423__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18090,(7),null);
...
var arr = [];
var seq__18103_18115 = cljs.core.seq(form);
var chunk__18104_18116 = null;
var count__18105_18117 = (0);
var i__18106_18118 = (0);
while(true){
if((i__18106_18118 < count__18105_18117)){
var x_18119 = chunk__18104_18116.cljs$core$IIndexed$_nth$arity$2(null,i__18106_18118);
arr.push(x_18119);

var G__18120 = seq__18103_18115;
var G__18121 = chunk__18104_18116;
var G__18122 = count__18105_18117;
var G__18123 = (i__18106_18118 + (1));
seq__18103_18115 = G__18120;
chunk__18104_18116 = G__18121;
count__18105_18117 = G__18122;
i__18106_18118 = G__18123;
continue;
} else {
var temp__4425__auto___18124 = cljs.core.seq(seq__18103_18115);
if(temp__4425__auto___18124){
var seq__18103_18125__$1 = temp__4425__auto___18124;
if(cljs.core.chunked_seq_QMARK_(seq__18103_18125__$1)){
var c__5474__auto___18126 = cljs.core.chunk_first(seq__18103_18125__$1);
var G__18127 = cljs.core.chunk_rest(seq__18103_18125__$1);
var G__18128 = c__5474__auto___18126;
var G__18129 = cljs.core.count(c__5474__auto___18126);
var G__18130 = (0);
seq__18103_18115 = G__18127;
chunk__18104_18116 = G__18128;
count__18105_18117 = G__18129;
i__18106_18118 = G__18130;
continue;
} else {
var x_18131 = cljs.core.first(seq__18103_18125__$1);
arr.push(x_18131);

var G__18132 = cljs.core.next(seq__18103_18125__$1);
var G__18133 = null;
var G__18134 = (0);
var G__18135 = (0);
seq__18103_18115 = G__18132;
chunk__18104_18116 = G__18133;
count__18105_18117 = G__18134;
i__18106_18118 = G__18135;
continue;
}
} else {
}
...
var obj = {};
var seq__18109_18136 = cljs.core.seq(form);
var chunk__18110_18137 = null;
var count__18111_18138 = (0);
var i__18112_18139 = (0);
while(true){
if((i__18112_18139 < count__18111_18138)){
var vec__18113_18140 = chunk__18110_18137.cljs$core$IIndexed$_nth$arity$2(null,i__18112_18139);
var k_18141 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113_18140,(0),null);
var v_18142 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113_18140,(1),null);
(obj[cljs.core.name(k_18141)] = v_18142);

var G__18143 = seq__18109_18136;
var G__18144 = chunk__18110_18137;
var G__18145 = count__18111_18138;
var G__18146 = (i__18112_18139 + (1));
seq__18109_18136 = G__18143;
chunk__18110_18137 = G__18144;
count__18111_18138 = G__18145;
i__18112_18139 = G__18146;
continue;
} else {
var temp__4425__auto___18147 = cljs.core.seq(seq__18109_18136);
if(temp__4425__auto___18147){
var seq__18109_18148__$1 = temp__4425__auto___18147;
if(cljs.core.chunked_seq_QMARK_(seq__18109_18148__$1)){
var c__5474__auto___18149 = cljs.core.chunk_first(seq__18109_18148__$1);
var G__18150 = cljs.core.chunk_rest(seq__18109_18148__$1);
var G__18151 = c__5474__auto___18149;
var G__18152 = cljs.core.count(c__5474__auto___18149);
var G__18153 = (0);
seq__18109_18136 = G__18150;
chunk__18110_18137 = G__18151;
count__18111_18138 = G__18152;
i__18112_18139 = G__18153;
continue;
} else {
var vec__18114_18154 = cljs.core.first(seq__18109_18148__$1);
var k_18155 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18114_18154,(0),null);
var v_18156 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18114_18154,(1),null);
(obj[cljs.core.name(k_18155)] = v_18156);

var G__18157 = cljs.core.next(seq__18109_18148__$1);
var G__18158 = null;
var G__18159 = (0);
var G__18160 = (0);
seq__18109_18136 = G__18157;
chunk__18110_18137 = G__18158;
count__18111_18138 = G__18159;
i__18112_18139 = G__18160;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__18161 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__18161) : cljs.core.atom.call(null,G__18161));
})();
...
var G__18165 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__18165) : pfn.call(null,G__18165));
} else {
if(cljs.core.truth_(dfn)){
var G__18166 = tag;
var G__18167 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__18166,G__18167) : dfn.call(null,G__18166,G__18167));
} else {
